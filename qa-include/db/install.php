	...
	*/
	...
	$tables = array(
		'users' => array(
			...
			'firstname' => 'VARCHAR(' . QA_DB_MAX_PROFILE_TITLE_LENGTH . ') NOT NULL', // first name
			'lastname' => 'VARCHAR(' . QA_DB_MAX_PROFILE_TITLE_LENGTH . ') NOT NULL', // last name
			'sex' => 'TINYINT UNSIGNED NOT NULL', // is brother, sister, organisation...
			'country' => 'VARCHAR(' . QA_DB_MAX_PROFILE_TITLE_LENGTH . ') NOT NULL', // country
			'mobile' => 'VARCHAR(' . QA_DB_MAX_HANDLE_LENGTH . ') NOT NULL',
		...
		'messages' => array(
			...
			'type' => 'VARCHAR(' . QA_DB_MAX_NAME_LENGTH . ')',
		...
		'contentwords' => array(
			...
			'type' => 'VARCHAR(' . QA_DB_MAX_NAME_LENGTH . ')', // the post's type (copied here for quick searching)
...
function qa_db_default_userfields_sql()
{
	...
	$profileFields = array(
		array('title' => 'occupation', 'position' => 1, 'flags' => 0, 'permit' => QA_PERMIT_ALL),
		array('title' => 'location', 'position' => 2, 'flags' => 0, 'permit' => QA_PERMIT_ALL),
		array('title' => 'website', 'position' => 3, 'flags' => QA_FIELD_FLAGS_LINK_URL, 'permit' => QA_PERMIT_ALL),
		array('title' => 'about', 'position' => 4, 'flags' => QA_FIELD_FLAGS_MULTI_LINE, 'permit' => QA_PERMIT_ALL),
	);
