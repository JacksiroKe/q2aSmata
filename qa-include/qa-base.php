...
<html>
	...
	echo '<div class="main-section-error rounded">
			<div class="title-section-error rounded_i">	
				<h1>AppSmata fatal error:</h1>
			</div>';
		
	echo '<div class="content-section-error"><p class="msg-error">' . qa_html($message, true) . '</p>';
	@error_log('PHP Question2Answer fatal error: ' . $message);
	echo '<p class="msg-error">Stack trace:<p>';
	...
	echo '</div><div class="content-section-error rounded_ii">
			<center>
				<p>Copyright &copy; Question2Answer by Gideon Greenspan and contributors '.date('Y').'</p>
			</center>
		</div>
	</body>
</html>';
...
function qa_string_to_array($string_list) {
	$strings = @$string_list;
