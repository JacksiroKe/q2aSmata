 ...
 * @return mixed
 */
function qa_create_new_user($firstname, $lastname, $sex, $country, $mobile, $email, $password, $handle, $level = QA_USER_LEVEL_BASIC, $confirmed = false)
{
	...
	$userid = qa_db_user_create($firstname, $lastname, $sex, $country, $mobile, $email, $password, $handle, $level, qa_remote_ip_address());
