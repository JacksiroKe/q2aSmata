...
function qa_get_request_content()
{
	...
	$userid = qa_handle_to_userid($firstlower);
	if (isset($userid)) {
		$as_content = require QA_INCLUDE_DIR . 'pages/user.php';
	} else if (isset($routing[$requestlower])) {
...
function qa_page_routing()
{
	...
	return array(
		...
		// ** Added Line Begin
		'admin/editor' => 'pages/admin/admin-editor.php',
		// ** Added line End
