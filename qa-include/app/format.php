...
function qa_user_sub_navigation($handle, $selected, $ismyuser = false)
{
	$navigation = array(
		'profile' => array(
			'label' => qa_html(qa_get_user_name($handle)),
		...
		'activity' => array(
			...
			'url' => qa_path_html($handle . '/activity'),
		),

		'questions' => array(
			'label' => qa_lang_html('misc/nav_user_qs'),
			'url' => qa_path_html($handle . '/questions'),
		),

		'answers' => array(
			'label' => qa_lang_html('misc/nav_user_as'),
			'url' => qa_path_html($handle . '/answers'),
		),
	);
