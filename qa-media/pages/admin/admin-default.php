...
switch ($adminsection) {
	...
	case 'emails':
		...
		$showoptions = array(
			...
			'smtp_active', 'smtp_address', 'smtp_port', 'smtp_secure', 'smtp_authenticate', 'smtp_username', 'smtp_password', '', 'mailing_sub_title', 'mailing_enabled', 'mailing_from_name', 'mailing_from_email', 'mailing_subject', 'mailing_body', 'mailing_per_minute'
		);
	...
	case 'users':
		...
		// ** Added Line Begin
		$showoptions = array('show_notice_visitor', 'notice_visitor', 'notice_visitor_htmledit');

		if (!QA_FINAL_EXTERNAL_USERS) {
			require_once QA_INCLUDE_DIR . 'util/image.php';
			array_push($showoptions, 'show_custom_register', 'custom_register', 'custom_register_htmledit', 'show_register_terms', 'register_terms', 'register_terms_htmledit', 'show_notice_welcome', 'notice_welcome', 'notice_welcome_htmledit', 'show_custom_welcome', 'custom_welcome',
		...
		$checkboxtodisplay = array(
			...
			'custom_register_htmledit' => 'option_show_custom_register',
			'register_terms' => 'option_show_register_terms',
			'register_terms_htmledit' => 'option_show_register_terms',
			'custom_welcome' => 'option_show_custom_welcome',
			'custom_welcome_htmledit' => 'option_show_custom_welcome',
			'notice_welcome' => 'option_show_notice_welcome',
			'notice_welcome_htmledit' => 'option_show_notice_welcome',
			'notice_visitor' => 'option_show_notice_visitor',
			'notice_visitor_htmledit' => 'option_show_notice_visitor',
	...
	case 'layout':
		...
		// ** Added Line Begin
		$showoptions = array('logo_show', 'logo_url', 'logo_width', 'logo_height', '', 'show_custom_sidebar', 'custom_sidebar_htmledit', 'custom_sidebar', 'show_custom_sidepanel', 'custom_sidepanel', 'custom_sidepanel_htmledit', 'show_custom_header', 'custom_header', 'custom_header_htmledit', 'show_custom_footer', 'custom_footer', 'custom_footer_htmledit', 'show_custom_in_head', 'custom_in_head', 'custom_in_head_htmledit', 'show_custom_home', 'custom_home_heading', 'custom_home_content', 'custom_home_content_htmledit', 'show_home_description', 'home_description', '');
		...
		$checkboxtodisplay = array(
			...
			'custom_sidebar_htmledit' => 'option_show_custom_sidebar',
			'custom_sidepanel' => 'option_show_custom_sidepanel',
			'custom_sidepanel_htmledit' => 'option_show_custom_sidepanel',
			'custom_header' => 'option_show_custom_header',
			'custom_header_htmledit' => 'option_show_custom_header',
			'custom_footer' => 'option_show_custom_footer',
			'custom_footer_htmledit' => 'option_show_custom_footer',
			'custom_in_head' => 'option_show_custom_in_head',
			'custom_in_head_htmledit' => 'option_show_custom_in_head',
			'custom_home_heading' => 'option_show_custom_home',
			'custom_home_content' => 'option_show_custom_home',
			'custom_home_content_htmledit' => 'option_show_custom_home',
	...
	case 'posting':
		...
		// ** Added Line Begin
		array_push($showoptions, 'show_custom_ask', 'custom_ask', 'custom_ask_htmledit', 'extra_field_active', 'extra_field_prompt', 'extra_field_display', 'extra_field_label', 'show_custom_answer', 'custom_answer', 'custom_answer_htmledit', 'show_custom_comment', 'custom_comment', 'custom_comment_htmledit', '');
		// ** Added Line End
		...
		$checkboxtodisplay = array(
			...
			'custom_ask_htmledit' => 'option_show_custom_ask',
			...
			'custom_answer_htmledit' => 'option_show_custom_answer',
			...
			'custom_comment_htmledit' => 'option_show_custom_comment && (option_comment_on_qs || option_comment_on_as)',
...
foreach ($showoptions as $optionname) {
	...
	// ** Added Line Begin
	elseif (strpos($optionname, 'htmledit') !== false) {	
		$itemname = explode("_htmledit", @$optionname);		
		$qa_content['form']['fields'][] = array(
			'id' => $optionname,
			'type' => 'custom',
			'style' => 'tall',
			'html' => '<a href="editor?item='.$itemname[0].'"> >> You can use a HTML Editor instead</a>',
		);
		$indented = false;
	}
	// ** Added Line End	
	elseif (strpos($optionname, '/') !== false) {
		...
		switch ($optionname) { // special treatment for certain options
			case 'mailing_sub_title':		
				$optionfield = array(
					'id' => $optionname,
					'type' => 'custom',
					'style' => 'tall',
					'html' => '<h1>'. qa_lang_html('admin/mailing_title') .'</h1>',
				);
				$indented = false;
				break;
			case 'site_language':
